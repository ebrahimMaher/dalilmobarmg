...
> جرب التحقق من متغير حساب المعلم، بإستخدام `isStudent(teacher)` وانظر الناتج! 
...
عندما يجد المفسّر اﻷمر `return` عند تنفيذ أوامر الدالة، يقوم بإرجاع القيمة ويتوقف عن تنفيذ أوامر الدالة، ﻷن إرجاع القيمة من الدالة هو دائماً آخر شيء، لذلك 
...
وهي عبارة عن تقسيم البرنامج إلى عدة دوال كل منها ينفذ مهمة محددة، واستدعاء الدوال فقط في عدة أسطر أي يصبح البرنامج مكون من عدة أجزاء (دوال) كل منها منفصل عن اﻵخر وكل منها ينفذ شيء محدد، وبعد تجميعهم يُصبح البرنامج كاملاً ويسمى هذا اﻷسلوب من البرمجة ***البرمجة الوظيفية (Functional Programming)***
