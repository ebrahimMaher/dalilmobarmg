...
### مم يتكون المتغير؟
> من هنا يمكنك فتح محرر النصوص (vscode) ﻹجراء التجارب وتشغيل الكود ومعرفة الناتج... هل ليس عندك محرر النصوص vscode أو لم تجهز بيئة العمل حتى اﻵن؟ يمكنك الرجوع [لدرس تجهيز بيئة العمل ](/tutorials/algorithms/fundamentals/print)
تتكون المتغيرات من:
