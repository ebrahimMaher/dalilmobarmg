...
- قمنا بإنشاء متغير اسمه `result` وهو ناتج عملية الجمع، وفي البداية قيمته صفر ﻷننا لم نجمع عليه أي عدد حتى اﻵن
...
هذه العملية شبه مستحيلة عليك بعقلك، أن تضرب اﻷعداد من 1 إلى 1000 لكن يمكن للحاسوب القيام بها في جزء من الثانية! جربها اﻵن واعرف الناتج:
...
console.log(result);
```
> سنترككم تجربوا الكود وتنظروا الناتج! يمكن استخدام محرر دليل مبرمج السريع عن طريق الضغط على الزر أسفل يسار الشاشة

> لاحظ أننا غيرنا العملية من `+` إلى `*` وغيرنا عدد مرات التكرار من `10` إلى `1000`
