...
description: تعلم الحلقات التكرارية وأهميتها واستخداماتها
position: 7
...
### `While` loop
هي النوع الرئيسي من الحلقات التكرارية، وبفهمها تكون أتقنت الحلقات التكرارية، أما باقي اﻷنواع فهي مشتقة منها لتسهّل الاستخدام في حالات معينة فقط.
...
> لاحظ أننا غيرنا العملية من `+` إلى `*` وغي��نا عدد مرات التكرار من `10` إلى `20`
...
- أنشأنا متغير اسمه `hours` وسيكون هو عدد التكرارات، باستخدامه سيصبح تكرار الحلقة ديناميكي وليس ثابت، فإن تغيرت قيمته ستتغير عدد تكرارات الحلقة ﻷننا سنضع للحلقة شرط `i <= hours` وبالتالي سيتغير هذا الشرط بتغير `hours` فإن كان مثلاً قيمته `12` سيصبح الشرط `i <= 12` وهكذا.
...
- ثم استخدمنا الحلقة التكرارية كاستخدامنا لها في أي مثال سابق، تتكرر مادامت `i` أقل من أو تساوي عدد التكرارات أو عدد الساعات `hours` وتقوم بطباعة الساعة الحالية `i`
