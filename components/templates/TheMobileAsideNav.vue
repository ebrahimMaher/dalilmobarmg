<template>
  ...
  >
    ...
    >
      ...
      <button
        class="bookmark-button absolute h-10 w-10 flex items-center justify-center text-dalil-gray bg-gray-200 dark:bg-dark-surface dark:text-dark-onSurfaceSecondary transition-colors duration-300 ease-linear"
        @click="show = !show"
      >
        <ListIcon
          v-if="!show"
          class="block text-dalil-gray dark:text-dark-onSurfaceSecondary stroke-current transition-colors duration-300 ease-linear"
        />
        <TimesIcon
          v-else
          class="block h-5 fill-current transition-colors duration-300 ease-linear"
