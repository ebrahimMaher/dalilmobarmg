<template>
  ...
  >
    ...
    >
      <div
        class="flex flex-col sm:flex-row px-4 pt-6 justify-between lg:justify-start lg:flex-col lg:overflow-y-auto overflow-x-hidden lg:pl-0 lg:pr-6 sticky?lg:max-h-(screen-24)"
      >
        <slot />
      </div>
    </div>
