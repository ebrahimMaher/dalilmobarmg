<template>
  <div>
    ...
    <div class="w-full flex shadow-md text-base">
      <input v-model="value" class="field text-base flex-grow light:bg-light-elevatedSurface dark:bg-dark-elevatedSurface light:text-light-onSurfaceStrong dark:text-dark-onSurfaceStrong p-4 px-4 rounded-r" style="min-width: 100px;" type="text" placeholder="أدخل القيمة">
