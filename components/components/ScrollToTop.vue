<template>
    <div class="scroll-to-top">
        <transition name="fade-up-transition" appear>
            <button v-if="show" :class="{'text-orange-300': active}" class="btn bg-primary-base text-white hover:bg-primary-dark rounded-full flex items-center justify-center transform active:scale-95 transition duration-100 ease-linear" @click="scrollToTop">
