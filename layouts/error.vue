<template>
  <div class="relative">
    ...
    >
      <div class="w-full lg:w-1/2 text-center lg:text-right pl-8">
        <h1 class="text-6xl font-medium leading-normal text-dalil-lightindigo">
          {{ error.statusCode }}
        </h1>
        <h3
...
import IllustrationMountainsGlobe from '~/components/illustrations/IllustrationMontainsGlobe'
export default {
  components: {
    IllustrationMountainsGlobe,
    LostImageIllustration
